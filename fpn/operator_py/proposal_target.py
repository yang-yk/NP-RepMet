...
class ProposalTargetOperator(mx.operator.CustomOp):
    ...
    def forward(self, is_train, req, in_data, out_data, aux):
        ...
        rois, labels, neg_labels, bbox_targets, bbox_weights = \
        ...
        for ind, val in enumerate([rois, labels, neg_labels, bbox_targets, bbox_weights]):
...
class ProposalTargetProp(mx.operator.CustomOpProp):
    ...
    def list_outputs(self):
        return ['rois_output', 'label', 'neg_label', 'bbox_target', 'bbox_weight']
